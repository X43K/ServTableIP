        ...
        for iface, iface_ip, red in interfaces_disponibles:
            try:
                ...
                if local_ip:
                    ...
                    nombre_local = f"Este equipo {iface}"

                    # Si no existe en mapa_actual, añadirlo con la etiqueta "Este equipo <iface>"
                    if local_ip not in mapa_actual and local_mac:
                        mapa_actual[local_ip] = {
                            "ip": local_ip,
                            "mac": local_mac,
                            # host=Este equipo <iface> (esto es lo que pediste)
                            "host": nombre_local,
                        ...
                        # Forzar que el host local sea "Este equipo <iface>"
